...
/**
 * {@link Blocker} implementation of Blueprint technology.
 */
public class BlueprintBlockerImpl extends AbstractBlocker implements BlueprintListener {

    /**
     * Map for storing the blocker bundle ids with the Blueprint events that show what is blocking.
     */
    private final Map<Long, BlueprintEvent> blockerBlueprintBundles = new ConcurrentHashMap<Long, BlueprintEvent>();

    /**
     * Whether or not this {@link Blocker} currently blocks.
     */
     ...
     */
    private ServiceRegistration<BlueprintListener> blueprintListenerServiceRegistration;
    ...
    public void stop() {
        blueprintListenerServiceRegistration.unregister();
    }
